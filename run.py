...
def main():
    ...
    while True:
        ...
        if short_code == 'cu':
            ...
            while True:
                print("A: View  saved credential")
                print("B: Add  credential")
                print("C: Remove credential")
                print("D: Search credential")
                print("E: sign Out")
                option = input()
                ...
                if option == 'B':
                    while True:
                        ...
                        if choice == 'y':
                            ...
                            print("To generate random password enter keyword 'gen' or 'new' to create your own password")
                            keyword = input().lower()
                            if keyword == 'gen':
                                account_password = random.randint(222222, 222222)
